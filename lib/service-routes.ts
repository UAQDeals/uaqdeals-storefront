...
export const DEDICATED: Record<string, string> = {
  ...
  pest_control:         "/services/appointment/pest_control",
  home_services:        "/services/appointment/home_services",
  construction_painting:"/services/appointment/construction_painting",
  cleaning_service:     "/services/appointment/cleaning_service",
  tailor_shop:          "/services/appointment/tailor_shop",
  barber_shop:          "/services/appointment/barber_shop",
  clinics:              "/services/appointment/clinics",
